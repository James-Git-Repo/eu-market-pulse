-- Insert mock articles into Articles table
INSERT INTO public."Articles" (slug, title, subtitle, tag, author, read_time, published_at, content, image_url) VALUES
('eu-banks-nim-compression', 'Earnings Pulse: EU Banks'' NIM Compression vs. Resilient Fees', 'Why guidance beats beats: reading the spread between commentary and consensus.', 'Banks', 'TSN Desk', '6 min', '2025-10-01', '# Earnings Pulse: EU Banks'' NIM Compression vs. Resilient Fees
...
Investment banks with strong trading desks and wealth management arms are outperforming traditional retail-focused players.', '/src/assets/cover-banks.jpg'),

('semis-cyclicals-growth', 'Semis in Europe: Cyclicals Wearing Growth Clothing', 'Capex, export mix, and the FX tailwinds that actually matter.', 'Tech', 'TSN Desk', '7 min', '2025-09-29', '# Semis in Europe: Cyclicals Wearing Growth Clothing
...
Watch for inventory normalization cycles and order book commentary in upcoming earnings.', '/src/assets/cover-tech.jpg'),

('pharma-pricing-pressure', 'Pharma Pricing Pressure: Reading Between Policy Lines', 'How European pharma navigates pricing reforms without headline drama.', 'Healthcare', 'TSN Desk', '5 min', '2025-09-27', '# Pharma Pricing Pressure: Reading Between Policy Lines
...
The key metric to watch: gross-to-net deductions as a percentage of list price. This reveals true pricing power.', '/src/assets/cover-healthcare.jpg'),

('energy-transition-metals', 'Energy Transition: The Metals Supply Bottleneck', 'Why copper, lithium, and nickel prices tell different stories.', 'Energy', 'TSN Desk', '8 min', '2025-09-25', '# Energy Transition: The Metals Supply Bottleneck
...
European mining companies with advanced-stage projects in stable jurisdictions trade at significant premiums for good reason.', '/src/assets/cover-energy.jpg'),

('luxury-slowdown-signals', 'Luxury Slowdown: Separating Noise from Signal', 'When aspirational demand shifts, high-end resilience becomes key.', 'Consumer', 'TSN Desk', '6 min', '2025-09-23', '# Luxury Slowdown: Separating Noise from Signal
...
Companies with 40%+ UHNW exposure are significantly outperforming mass-luxury plays.', '/src/assets/cover-consumer.jpg'),

('insurance-reinsurance-rates', 'Insurance Reinsurance Rates: The Hidden Rate Cycle', 'Property cat rates up 30%, but casualty tells the real story.', 'Insurance', 'TSN Desk', '7 min', '2025-09-21', '# Insurance Reinsurance Rates: The Hidden Rate Cycle
...
Combined ratios below 95% are sustainable in this environment, supporting attractive returns.', '/src/assets/cover-insurance.jpg');